"""Upload franchise_a CSV files to GCP bucket."""
...
GCS_DEST_PREFIX = "landing_zone/franchise_a/"
LOCAL_DIR = "../data_generator/storage/landing_zone/franchise_a"
...
def upload():
    ...
    if not files:
        print("No CSV files found in franchise_a.")
        return
